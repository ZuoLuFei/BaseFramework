...
extension KRProgressHUD {
    func setUpConstraints() {
        hudViewCenterYConstraint = NSLayoutConstraint(item: hudView,
                                                      attribute: .centerY,
                                                      toItem: hudViewController.view,
    ...
    func setConstraintsToPresentingVC() {
        ...
        view.addConstraints([
            NSLayoutConstraint(item: hudViewController.view, attribute: .top, toItem: view, constant: (UIApplication.shared.statusBarFrame.height + 44)),
