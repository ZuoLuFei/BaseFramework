//
//  UIColor+kcExtension.swift
/*******************************************************************************
 # File        : UIColor+kcExtension.swift
 # Project     : &&&&
 # Author      : ####
 # Created     : 2018/9/10
 # Corporation : ****
...
extension UIColor {
    ...
    static func hex(value: UInt32, alpha: CGFloat = 1) -> UIColor {
        let r = CGFloat((value & 0xff0000) >> 16)
        let g = CGFloat((value & 0x00ff00) >> 8)
        let b = CGFloat(value & 0x0000ff)
        return UIColor.rgb(r: r, g: g, b: b, a: alpha)
    }

    static func hexString(value: String) -> UIColor {
        ...
        return UIColor.rgb(r: CGFloat(red), g: CGFloat(green), b: CGFloat(blue), a: CGFloat(alpha / 255.0))
    }
}
